...
<body>
	...
	<?php
		...
		echo '<h4 id="intentsRestants">4</h4>';
		echo '<h4> ATTEMPT(S) LEFT:	'; 
		echo '<progress id="progressFirst"></progress> <progress id="progressSecond"></progress> <progress id="progressThird"></progress> <progress id="progressFourth" ></progress></h4><br>';
